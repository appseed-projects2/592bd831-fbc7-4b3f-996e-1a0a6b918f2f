...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-23 12:25`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/592bd831-fbc7-4b3f-996e-1a0a6b918f2f.git
$ cd 592bd831-fbc7-4b3f-996e-1a0a6b918f2f
```
